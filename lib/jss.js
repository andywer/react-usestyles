...
function createUnifiedSheet (sheetKey, jss, manager, registry, styles, jssSheetOptions) {
...
export function JssProvider (props) {
  ...
  const createSheet = (styles, themeID, sheetOptions = {}) => {
    ...
    return createUnifiedSheet(sheetKey, jss, manager, props.registry, styles, props.sheetOptions || {})
  }
